...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$181;
  if (canUseDOM) {
    var isSupported$jscomp$inline_322 = "oninput" in document;
    if (!isSupported$jscomp$inline_322) {
      var element$jscomp$inline_323 = document.createElement("div");
      element$jscomp$inline_323.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_322 =
        "function" === typeof element$jscomp$inline_323.oninput;
    }
    JSCompiler_inline_result$jscomp$181 = isSupported$jscomp$inline_322;
  } else JSCompiler_inline_result$jscomp$181 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$181 &&
...
for (
  var i$jscomp$inline_363 = 0;
  i$jscomp$inline_363 < simpleEventPluginEvents.length;
  i$jscomp$inline_363++
) {
  var eventName$jscomp$inline_364 =
      simpleEventPluginEvents[i$jscomp$inline_363],
    domEventName$jscomp$inline_365 = eventName$jscomp$inline_364.toLowerCase(),
    capitalizedEvent$jscomp$inline_366 =
      eventName$jscomp$inline_364[0].toUpperCase() +
      eventName$jscomp$inline_364.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_365,
    "on" + capitalizedEvent$jscomp$inline_366
  );
}
    ...
    switch (fiber.tag) {
      ...
      case 3:
        var lane = requestUpdateLane(fiber),
          ...
          root$60 = scheduleUpdateOnFiber(fiber, lane, eventTime);
        null !== root$60 && entangleTransitions(root$60, fiber, lane);
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function(subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      includesBlockingLane(root$57, renderLanes) ||
            ...
            switch (firstChild.tag) {
              case 13:
                if (null !== firstChild.memoizedState) {
                  var current$139 = firstChild.alternate;
                  if (
                    null === current$139 ||
                    null === current$139.memoizedState
                  )
            ...
            if (0 !== (fiber$jscomp$0.flags & 8772))
              switch (fiber$jscomp$0.tag) {
                ...
                case 1:
                  ...
                  break;
                case 3:
                  var updateQueue$134 = fiber$jscomp$0.updateQueue;
                  if (null !== updateQueue$134) {
                    current = null;
                    ...
                    commitUpdateQueue(fiber$jscomp$0, updateQueue$134, current);
                  }
                  break;
                case 5:
                  var instance$136 = fiber$jscomp$0.stateNode;
                  null === current &&
                    fiber$jscomp$0.flags & 4 &&
                    ((current = instance$136),
...
var COMPONENT_TYPE = 0,
  ...
  TEXT_TYPE = 4;
if ("function" === typeof Symbol && Symbol.for) {
  var symbolFor$152 = Symbol.for;
  COMPONENT_TYPE = symbolFor$152("selector.component");
  HAS_PSEUDO_CLASS_TYPE = symbolFor$152("selector.has_pseudo_class");
  ROLE_TYPE = symbolFor$152("selector.role");
  TEST_NAME_TYPE = symbolFor$152("selector.test_id");
  TEXT_TYPE = symbolFor$152("selector.text");
}
      ...
      switch (didTimeout) {
        ...
        case 4:
          ...
          for (prevExecutionContext = -1; 0 < lanes; ) {
            ...
            index$10 > prevExecutionContext &&
              (prevExecutionContext = index$10);
            lanes &= ~prevDispatcher;
          }
          lanes = prevExecutionContext;
          lanes = now() - lanes;
    ...
    try {
      ...
      a: {
        ...
        if (
          ...
          var suspenseBoundary$64 = getNearestSuspenseBoundaryToCapture(
            returnFiber
          );
          if (null !== suspenseBoundary$64) {
            0 === (suspenseBoundary$64.flags & 65536) &&
              (suspenseBoundary$64.flags |= 256);
            markSuspenseBoundaryShouldCapture(
              suspenseBoundary$64,
              returnFiber,
              sourceFiber,
          ...
          switch (sourceFiber.tag) {
            ...
            case 1:
              ...
              if (
                ...
                thrownValue &= -thrownValue;
                sourceFiber.lanes |= thrownValue;
                var update$67 = createClassErrorUpdate(
                  sourceFiber,
                  root,
                  thrownValue
                );
                enqueueCapturedUpdate(sourceFiber, update$67);
                break a;
              }
          }
          sourceFiber = sourceFiber.return;
                ...
                try {
                  switch (((fiberToDelete = deletions), fiberToDelete.tag)) {
                    ...
                    case 24:
                      ...
                      null !== fiberToDelete.alternate &&
                        (cache = fiberToDelete.alternate.memoizedState.cache);
                      var nextCache$150 = fiberToDelete.memoizedState.cache;
                      nextCache$150 !== cache &&
                        (nextCache$150.refCount++,
                        null != cache && releaseCache(cache));
                  }
                } catch (error) {
...
_attemptSynchronousHydration = function(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$162 = fiber.stateNode;
      if (root$162.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$162.pendingLanes);
        0 !== lanes &&
          (markRootEntangled(root$162, lanes | 1),
          ensureRootIsScheduled(root$162, now()),
          0 === (executionContext & 6) &&
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1434 = {
    findFiberByHostInstance: getClosestInstanceFromNode,
    bundleType: 0,
    version: "17.0.3",
    rendererPackageName: "react-dom"
  };
var internals$jscomp$inline_1843 = {
  bundleType: devToolsConfig$jscomp$inline_1434.bundleType,
  version: devToolsConfig$jscomp$inline_1434.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1434.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1434.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1434.findFiberByHostInstance ||
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1844 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1844.isDisabled &&
    hook$jscomp$inline_1844.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1844.inject(
        internals$jscomp$inline_1843
      )),
        (injectedHook = hook$jscomp$inline_1844);
    } catch (err) {}
}
