...
var disableInputAttributeSyncing =
  ...
  enableClientRenderFallbackOnHydrationMismatch =
    dynamicFeatureFlags.enableClientRenderFallbackOnHydrationMismatch; // On WWW, true is used for a new modern build.
...
var enableSuspenseAvoidThisFallback = true;
...
var didNotHydrateInstanceWithinContainer = shim;
var didNotHydrateInstanceWithinSuspenseInstance = shim;
    ...
    switch (returnFiber.tag) {
      ...
      case SuspenseComponent:
        ...
        if (suspenseState.dehydrated !== null)
          didNotHydrateInstanceWithinSuspenseInstance(suspenseState.dehydrated);
        break;
    }
  }
}
...
function restoreSpawnedCachePool(offscreenWorkInProgress, prevCachePool) {
  ...
  if (nextParentCache !== prevCachePool.parent) {
    ...
    // peekCacheFromPool).
    push(resumedCache, prevCachePool.pool, offscreenWorkInProgress); // Return the cache pool to signal that we did in fact push it. We will
