...
var dynamicFeatureFlags = require("ReactFeatureFlags"),
  ...
  enableClientRenderFallbackOnHydrationMismatch =
    dynamicFeatureFlags.enableClientRenderFallbackOnHydrationMismatch,
...
function setValueForProperty(node, name, value, isCustomComponentTag) {
  ...
  if (!JSCompiler_inline_result$jscomp$0) {
    if (isCustomComponentTag && "o" === name[0] && "n" === name[1]) {
      ...
      JSCompiler_inline_result$jscomp$0 = JSCompiler_inline_result$jscomp$0.slice(
        2
      );
...
function findInstanceBlockingEvent(
  ...
  if (null !== domEventName)
    if (
      ...
      if (eventSystemFlags.stateNode.isDehydrated)
...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$197;
  if (canUseDOM) {
    var isSupported$jscomp$inline_349 = "oninput" in document;
    if (!isSupported$jscomp$inline_349) {
      var element$jscomp$inline_350 = document.createElement("div");
      element$jscomp$inline_350.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_349 =
        "function" === typeof element$jscomp$inline_350.oninput;
    }
    JSCompiler_inline_result$jscomp$197 = isSupported$jscomp$inline_349;
  } else JSCompiler_inline_result$jscomp$197 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$197 &&
...
for (
  var i$jscomp$inline_390 = 0;
  i$jscomp$inline_390 < simpleEventPluginEvents.length;
  i$jscomp$inline_390++
) {
  var eventName$jscomp$inline_391 =
      simpleEventPluginEvents[i$jscomp$inline_390],
    domEventName$jscomp$inline_392 = eventName$jscomp$inline_391.toLowerCase(),
    capitalizedEvent$jscomp$inline_393 =
      eventName$jscomp$inline_391[0].toUpperCase() +
      eventName$jscomp$inline_391.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_392,
    "on" + capitalizedEvent$jscomp$inline_393
  );
}
...
function popHydrationState(fiber) {
  ...
  if (JSCompiler_temp && (JSCompiler_temp = nextHydratableInstance)) {
    if (shouldClientRenderOnMismatch(fiber)) {
      for (fiber = nextHydratableInstance; fiber; )
    ...
    switch (fiber.tag) {
      ...
      case 3:
        var lane = requestUpdateLane(fiber),
          ...
          root$65 = scheduleUpdateOnFiber(fiber, lane, eventTime);
        null !== root$65 && entangleTransitions(root$65, fiber, lane);
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function(subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      var root$61 = workInProgressRoot;
      if (null === root$61) throw Error(formatProdErrorMessage(349));
      includesBlockingLane(root$61, renderLanes) ||
        pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
    }
    hook.memoizedState = getServerSnapshot;
    root$61 = { value: getServerSnapshot, getSnapshot: getSnapshot };
    hook.queue = root$61;
    mountEffect(subscribeToStore.bind(null, fiber, root$61, subscribe), [
      subscribe
    ]);
    fiber.flags |= 2048;
    pushEffect(
  ...
  useId: function() {
    ...
    if (isHydrating) {
      ...
      0 < JSCompiler_inline_result &&
        (identifierPrefix += ":" + JSCompiler_inline_result.toString(32));
    } else
      (JSCompiler_inline_result = globalClientIdCounter++),
        (identifierPrefix =
          identifierPrefix + "r:" + JSCompiler_inline_result.toString(32));
        ...
        (JSCompiler_temp =
          null !== JSCompiler_temp
            ? null !== JSCompiler_temp.dehydrated
              ? !0
              : !1
            : !0 !== returnFiber.memoizedProps.unstable_avoidThisFallback
            ? !0
    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$79.lanes | child$79.childLanes),
          (subtreeFlags |= child$79.subtreeFlags & 14680064),
          (subtreeFlags |= child$79.flags & 14680064),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$78.subtreeFlags & 14680064),
          (subtreeFlags |= treeBaseDuration$78.flags & 14680064),
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (
        ...
        for (newProps = nextHydratableInstance; newProps; )
          newProps = getNextHydratable(newProps.nextSibling);
        resetHydrationState();
      ...
      null !== hydrationErrors &&
        ...
        null === workInProgressRootRecoverableErrors
          ? (workInProgressRootRecoverableErrors = i)
    ...
    case 23:
      return (
        ...
        null !== workInProgress.updateQueue && pop(resumedCache),
        null
      );
    case 24:
      return (
      ...
      return (
        null !== prevState
          ? ((nextChildren = prevState.baseLanes | renderLanes),
            (spawnedCachePool = peekCacheFromPool()),
            (spawnedCachePool =
              null === spawnedCachePool
                ? null
                : {
                    parent: CacheContext._currentValue,
                    pool: spawnedCachePool
                  }))
      ...
      if (
        ...
        "$?" === JSCompiler_temp.data
          ? ((workInProgress.flags |= 128),
            ...
            (workInProgress = null))
          : ((renderLanes = suspenseContext.treeContext),
            ...
            switch (firstChild$jscomp$0.tag) {
              case 13:
                if (null !== firstChild$jscomp$0.memoizedState) {
                  var current$157 = firstChild$jscomp$0.alternate;
                  if (
                    null === current$157 ||
                ...
                break;
              case 22:
                var isHidden$159 = null !== firstChild$jscomp$0.memoizedState,
                  current$160 = firstChild$jscomp$0.alternate,
                  wasHidden$161 =
                    null !== current$160 && null !== current$160.memoizedState;
                committedLanes = firstChild$jscomp$0;
                a: {
                  i = committedLanes;
                  childToDelete = isHidden$159;
        ...
        if (0 !== (fiber.flags & 8772))
          switch (fiber.tag) {
            ...
            case 1:
              ...
              break;
            case 3:
              var updateQueue$150 = fiber.updateQueue;
              if (null !== updateQueue$150) {
                current = null;
                if (null !== fiber.child)
                ...
                commitUpdateQueue(fiber, updateQueue$150, current);
              }
              break;
            case 5:
              var instance$152 = fiber.stateNode;
              null === current &&
                fiber.flags & 4 &&
                ((current = instance$152),
    ...
    if (1 === currentTime)
      0 === root.tag
        ...
        scheduleMicrotask(function() {
          0 === executionContext && flushSyncCallbacks();
        }),
  ...
  if (null !== workInProgress)
    for (timeoutHandle = workInProgress.return; null !== timeoutHandle; ) {
      ...
      switch (interruptedWork.tag) {
        ...
        case 23:
          popRenderLanes();
          null !== interruptedWork.updateQueue && pop(resumedCache);
          break;
        case 24:
          popProvider(CacheContext);
      }
  ...
  do {
    ...
    try {
      ...
      a: {
        ...
        if (
          null !== wakeable &&
          "object" === typeof wakeable &&
          "function" === typeof wakeable.then
        ) {
          var wakeable$jscomp$0 = wakeable,
          ...
          var suspenseBoundary$71 = getNearestSuspenseBoundaryToCapture(
            returnFiber
          );
          if (null !== suspenseBoundary$71) {
            0 === (suspenseBoundary$71.flags & 65536) &&
            ...
            thrownValue = wakeable;
            null === hydrationErrors
              ? (hydrationErrors = [thrownValue])
              : hydrationErrors.push(thrownValue);
            break a;
          }
        }
        root = wakeable;
        ...
        wakeable = createCapturedValue(wakeable, sourceFiber);
        ...
        do {
          switch (sourceFiber.tag) {
            case 3:
              ...
              sourceFiber.lanes |= thrownValue;
              var update = createRootErrorUpdate(
                sourceFiber,
                wakeable,
                thrownValue
              );
              enqueueCapturedUpdate(sourceFiber, update);
              break a;
            case 1:
              root = wakeable;
              var ctor = sourceFiber.type,
                instance = sourceFiber.stateNode;
              if (
                ...
                enqueueCapturedUpdate(sourceFiber, update$74);
                break a;
              }
          }
          sourceFiber = sourceFiber.return;
...
function commitRootImpl(root, recoverableErrors, renderPriorityLevel) {
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || rootHasEffect) {
    ...
    executionContext |= 4;
    ReactCurrentOwner$2.current = null;
    var shouldFireAfterActiveInstanceBlur$175 = commitBeforeMutationEffects(
      root,
      finishedWork
    );
    commitTime = now$1();
    ...
    shouldFireAfterActiveInstanceBlur$175 &&
      ((_enabled = !0),
                ...
                try {
                  switch (((fiberToDelete = deletions), fiberToDelete.tag)) {
                    ...
                    case 24:
                      ...
                      null !== fiberToDelete.alternate &&
                        (cache = fiberToDelete.alternate.memoizedState.cache);
                      var nextCache$168 = fiberToDelete.memoizedState.cache;
                      nextCache$168 !== cache &&
                        (nextCache$168.refCount++,
                        null != cache && releaseCache(cache));
                  }
                } catch (error) {
...
_attemptSynchronousHydration = function(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$178 = fiber.stateNode;
      if (root$178.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$178.pendingLanes);
        0 !== lanes &&
          (markRootEntangled(root$178, lanes | 1),
          ensureRootIsScheduled(root$178, now()),
          0 === (executionContext & 6) &&
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1521 = {
...
(function(internals) {
  ...
  bundleType: devToolsConfig$jscomp$inline_1521.bundleType,
  version: devToolsConfig$jscomp$inline_1521.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1521.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1521.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1521.findFiberByHostInstance ||
...
exports.hydrateRoot = function(container, initialChildren, options) {
  ...
  if (mutableSources)
    for (container = 0; container < mutableSources.length; container++)
      (isStrictMode = mutableSources[container]),
        (concurrentUpdatesByDefaultOverride = isStrictMode._getVersion),
        (concurrentUpdatesByDefaultOverride = concurrentUpdatesByDefaultOverride(
          isStrictMode._source
        )),
  ...
  return new ReactDOMHydrationRoot(options);
};
