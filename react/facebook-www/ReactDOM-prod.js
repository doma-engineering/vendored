...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_333 = "oninput" in document;
    if (!isSupported$jscomp$inline_333) {
      var element$jscomp$inline_334 = document.createElement("div");
      element$jscomp$inline_334.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_333 =
        "function" === typeof element$jscomp$inline_334.oninput;
    }
    JSCompiler_inline_result$jscomp$181 = isSupported$jscomp$inline_333;
...
for (
  var i$jscomp$inline_374 = 0;
  i$jscomp$inline_374 < simpleEventPluginEvents.length;
  i$jscomp$inline_374++
) {
  var eventName$jscomp$inline_375 =
      simpleEventPluginEvents[i$jscomp$inline_374],
    domEventName$jscomp$inline_376 = eventName$jscomp$inline_375.toLowerCase(),
    capitalizedEvent$jscomp$inline_377 =
      eventName$jscomp$inline_375[0].toUpperCase() +
      eventName$jscomp$inline_375.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_376,
    "on" + capitalizedEvent$jscomp$inline_377
  );
}
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function(subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      includesBlockingLane(root$58, renderLanes) ||
  ...
  if (didBailout)
    for (var child$72 = completedWork.child; null !== child$72; )
      (newChildLanes |= child$72.lanes | child$72.childLanes),
        (subtreeFlags |= child$72.subtreeFlags & 14680064),
        (subtreeFlags |= child$72.flags & 14680064),
            ...
            switch (firstChild$jscomp$0.tag) {
              case 13:
                if (null !== firstChild$jscomp$0.memoizedState) {
                  var current$141 = firstChild$jscomp$0.alternate;
                  if (
                    null === current$141 ||
                    null === current$141.memoizedState
                  )
                    globalMostRecentFallbackTime = now();
                }
                break;
              case 22:
                var isHidden$143 = null !== firstChild$jscomp$0.memoizedState,
                  current$144 = firstChild$jscomp$0.alternate,
                  wasHidden$145 =
                    null !== current$144 && null !== current$144.memoizedState;
                deletions = firstChild$jscomp$0;
                a: {
                  i = deletions;
                  childToDelete = isHidden$143;
        ...
        if (0 !== (fiber.flags & 8772))
          switch (fiber.tag) {
            ...
            case 1:
              ...
              break;
            case 3:
              var updateQueue$136 = fiber.updateQueue;
              if (null !== updateQueue$136) {
                current = null;
                if (null !== fiber.child)
                ...
                commitUpdateQueue(fiber, updateQueue$136, current);
              }
              break;
            case 5:
              var instance$138 = fiber.stateNode;
              null === current &&
                fiber.flags & 4 &&
                ((current = instance$138),
    ...
    try {
      ...
      a: {
        ...
        if (
          ...
          var suspenseBoundary$66 = getNearestSuspenseBoundaryToCapture(
            returnFiber
          );
          ...
          switch (sourceFiber.tag) {
            ...
            case 1:
              ...
              if (
                ...
                enqueueCapturedUpdate(sourceFiber, update$69);
                break a;
              }
          }
          sourceFiber = sourceFiber.return;
                ...
                try {
                  switch (((fiberToDelete = deletions), fiberToDelete.tag)) {
                    ...
                    case 24:
                      ...
                      null !== fiberToDelete.alternate &&
                        (cache = fiberToDelete.alternate.memoizedState.cache);
                      var nextCache$152 = fiberToDelete.memoizedState.cache;
                      nextCache$152 !== cache &&
                        (nextCache$152.refCount++,
                        null != cache && releaseCache(cache));
                  }
                } catch (error) {
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1437 = {
...
var internals$jscomp$inline_1852 = {
  bundleType: devToolsConfig$jscomp$inline_1437.bundleType,
  version: devToolsConfig$jscomp$inline_1437.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1437.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1437.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1437.findFiberByHostInstance ||
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1853 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1853.isDisabled &&
    hook$jscomp$inline_1853.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1853.inject(
        internals$jscomp$inline_1852
      )),
        (injectedHook = hook$jscomp$inline_1853);
    } catch (err) {}
}
